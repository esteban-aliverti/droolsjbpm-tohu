...
public class QuestionTest {
	...
	public void testAnswerTypeChanged() {
		Question q = new Question();
		q.setAnswerType(Question.TYPE_NUMBER);
		q.setNumberAnswer(1L);
		assertEquals(1, q.getNumberAnswer());
		q.setAnswerType(Question.TYPE_TEXT);
		q.setAnswerType(Question.TYPE_NUMBER);
	...
	public void testAnswerTypeChangedToSame() {
		...
		q.setNumberAnswer(1L);
		assertEquals(1, q.getNumberAnswer());
		q.setAnswerType(Question.TYPE_NUMBER + ".ext");
		assertEquals(1, q.getNumberAnswer());
	}
	...
	public void testSetAnswer() {
		...
		assertEquals(123, q.getNumberAnswer());
	}
	...
	public void testGetAnswer() {
		...
		q.setAnswerType(Question.TYPE_DECIMAL);
	...
	public void testGetAnswerCustomType() {
		...
		q.setAnswerType(Question.TYPE_DECIMAL + ".ext");
		q.setDecimalAnswer(new BigDecimal("4.56"));
		assertEquals(new BigDecimal("4.56"), q.getAnswer());
	}
